...
const ingredients = [  
    {
        ...
        title: "Inari Sushi",
        description: "Sweet tofu pocket filled with seasoned rice",
        difficulty: "Beginner",
        time: "15 mins",
        servings: 2,
        prepTime: "10 mins",
        cookTime: "5mins",
        ingredients: [
            "4 inari age (sweet fried tofu pockets)",
            "2 cps sushi rice",
        ],
        instruction: [
           "Open the tofu pockets gently",
           "Stuff them with seasoned sushi rice",
           "Press lightly to shape the rice inside the tofu.",
